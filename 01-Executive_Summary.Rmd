...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing long-term sea surface temperatures averaged over the northeast U.S. continental shelf and adjacent waters."}
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing thermal layering of the upper 50m of the water column for the Gulf of Maine, Georges Bank and the Mid-Atlantic Bight"}
...
```{r, echo=FALSE, results=TRUE}
knitr::include_graphics("images/ex4-1.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing total amount of zooplankton (measured as displacement volume) for the Gulf of Maine, Georges Bank and the Mid-Atlantic Bight in NEFSC plankton surveys."}

knitr::include_graphics("images/ex4-2.png")
```

```{r, echo=FALSE, results=TRUE, fig.cap = " Chart showing trends in copepod species composition measured as the difference in abundance of small and large-bodied species"}

knitr::include_graphics("images/ex4-3.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in biomass in autumn NEFSC bottom trawl surveys for major fish groups including elasmobranchs, groundfish, small pelagic fish, and other finfish"}
knitr::include_graphics("images/ex5-1.png")

```

```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing estimated forage fish species biomass on the Northeast Shelf"}
knitr::include_graphics("images/ex5-2.png")

```


```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in biodiversity in NEFSC Spring Bottom Trawl surveys"}
knitr::include_graphics("images/ex5-3.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in mean trophic level of fish communities in NEFSC Spring Bottom Trawl surveys Figure 5.4"}
knitr::include_graphics("images/ex5-4.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing average along shelf position for a group of 48 species resident on the Northeast US Continental Shelf"}
knitr::include_graphics("images/ex5-5.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing change in condition presented as normalized time series from high to low condition."}
knitr::include_graphics("images/ex5-6.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing change in recruits per spawner presented as normalized time series for 20 groundfish stocks 1985-2010 from NEFSC stock assessment reports"}
knitr::include_graphics("images/ex5-7.png")
```
...
```{r, echo=FALSE, results=TRUE}
knitr::include_graphics("images/ex5-8.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in sea scallops for Georges Bank and the Mid Atlantic Bight based on assessments Figure 5.8 Chart showing lobster trends in the Gulf of Maine, Georges Bank and Southern New England"}
knitr::include_graphics("images/ex5-9.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = ""}

knitr::include_graphics("images/ex6-1.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing total landings for the Gulf of Maine, Georges Bank, and the Mid-Atlantic Bight Figure 6.1 Chart showing trends in fishery revenues by gear type on the Northeast Shelf"}

knitr::include_graphics("images/ex6-2.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in recreational harvest and caught and released fish"}
knitr::include_graphics("images/ex6-3.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing farmed salmon yield and value in Maine"}
knitr::include_graphics("images/ex6-4.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing fishing mortality relative to Fmsy and Biomass relative to Bmsy for Northeast stocks with known status"}
knitr::include_graphics("images/ex7-1.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in harbor seal and right whale population size on the Northeast Shelf"}
knitr::include_graphics("images/ex7-2.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in fledging success of puffins and arctic terns on nesting colonies on islands in the Gulf of Maine."}
knitr::include_graphics("images/ex7-3.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing trends in mercury, lead, and DDT in two NES ecoregions"}
knitr::include_graphics("images/ex8-1.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap="Chart showing composite index values for the Northeast U.S. Continental Shelf Large Marine Ecosystem"}
knitr::include_graphics("images/ex9-1.png")
```
...
```{r, echo=FALSE, results=TRUE, fig.cap = "Chart showing composite fishery index values for the Northeast U.S. Continental Shelf Large Marine Ecosystem"}
knitr::include_graphics("images/ex9-2.png")
```
